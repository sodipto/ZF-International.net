...
public partial class Account_WithdrawPaymentList : System.Web.UI.Page
{
    ...
    public void Show()
    {
        ...
        cmd.CommandText = "SELECT * FROM withdraw INNER join passenger ON withdraw.passportNo=passenger.Passport_No order by sr desc";
        cmd.ExecuteNonQuery();
    ...
    public void Show_Search()
    {
        ...
        cmd1.CommandText = "SELECT * FROM withdraw INNER join passenger ON withdraw.passportNo=passenger.Passport_No where withdraw.passportNo='" + TextBox1.Text + "' or withdraw.T_Date='" + TextBox1.Text + "'";
