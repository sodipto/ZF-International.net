...
public partial class Account_Payment : System.Web.UI.Page
{
    ...
    public void Show()
    {
        ...
        cmd.CommandText = "SELECT *FROM  passenger INNER join accountuser ON passenger.Passport_No=accountuser.passport ";//WHERE payment.passportNo='"++"';
        cmd.ExecuteNonQuery();
    ...
    public void Show_Search()
    {
        ...
        cmd1.CommandText = "SELECT *FROM  passenger INNER join accountuser ON passenger.Passport_No=accountuser.passport  where  passenger.Passport_No='" + TextBox1.Text + "' or passenger.name='" + TextBox1.Text + "'";
