<%@ Page Title="" Language="C#" MasterPageFile="~/Account/Account.master" AutoEventWireup="true" CodeFile="BalanceDetails.aspx.cs" Inherits="Account_BalanceDetails" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
      <%--   <div  class ="pull-right form-inline">
        ...
        <asp:TextBox ID="Search" class="form-control" runat="server"></asp:TextBox>
