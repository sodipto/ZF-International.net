...
public partial class Admin_WithdrawPayment : System.Web.UI.Page
{
   ...
   // string date_time;
    ...
    protected void paymentButton_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            Response.Write("<script> alert('Withdraw Balance Grater the Total balance , not withdraw');</script>");
            Balance.Text = "";
