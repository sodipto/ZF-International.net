...
public partial class Admin_Addpayment : System.Web.UI.Page
{
   ...
   // string constring = "server=localhost;database=zfinternational;uid=zf;pwd=12345;"; // chage here
    ...
    protected void paymentButton_Click(object sender, EventArgs e)
    {
        ...
        //    cmd3.CommandText = "insert into accountuser (passport,Total_Balance) values ('" + Passport.Text + "','" + Balance.Text + "')";
        //    //MySqlDataReader r2;
        ...
        cmd2.CommandText = "insert into payment (passportNo,Balance,T_Date) values ('" + Passport.Text + "','" + Balance.Text + "','" + date_time.Text + "')";


        cmd2.ExecuteReader();

       // Response.Write("<script> alert('Payment Add Successfully');</script>");
        ...
        cmd9.CommandText = "SELECT SUM(Balance) FROM payment where passportNo='" + SearchTextbox.Text + "'";
        //cmd.CommandText = "select *from  passenger INNER JOIN payment ON passenger.Passport_No = payment.passportNo where passenger.Passport_No='" + SearchTextbox.Text + "'";


       // MySqlDataReader r8;

     //   r8 = cmd9.ExecuteReader();
        ...
        Bal_sum = result.ToString();
            ...
            cmd1.CommandText = "update accountuser set Total_Balance='" + Bal_sum + "' where passport='" + Passport.Text + "'";
