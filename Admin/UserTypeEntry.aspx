<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin MasterPage.master" AutoEventWireup="true" CodeFile="UserTypeEntry.aspx.cs" Inherits="Admin_UserTypeEntry" %>
			...
			<div class="row main">
				...
				<h5>User Entry</h5>
							...
							<div class="cols-sm-10">
								<div class="input-group">
									...
									<%--<input type="text" class="form-control" name="username" id="username"  placeholder="Enter your Username"/>--%>
                                     <asp:DropDownList ID="user" runat="server" CssClass="form-control ddl" OnSelectedIndexChanged="user_SelectedIndexChanged" AutoPostBack="True" >
						...
						<div class="form-group">
							...
							<div class="cols-sm-10">
								<div class="input-group">
                                    ...
                                    <asp:TextBox ID="name" class="form-control" placeholder="Enter your Name" runat="server" ValidationGroup="ui"></asp:TextBox>
							...
							<div class="cols-sm-10">
								<div class="input-group">
									<span class="input-group-addon"><i class="fa fa-lock fa-lg" aria-hidden="true"></i></span>
									 <asp:TextBox ID="password" class="form-control" placeholder="Enter your Password" runat="server" TextMode="Password" ValidationGroup="ui"></asp:TextBox>
						...
						<div class="form-group ">
                            ...
                            <asp:Button ID="RegisterUser" runat="server" class="btn btn-danger btn-lg btn-block login-button" Text="Register" OnClick="RegisterUser_Click" ValidationGroup="ui" onclientclick="Alert_insert()" />
						</div>
