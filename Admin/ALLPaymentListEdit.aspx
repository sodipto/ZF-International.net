<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin MasterPage.master" AutoEventWireup="true" CodeFile="ALLPaymentListEdit.aspx.cs" Inherits="Admin_ALLPaymentListEdit" %>
    ...
    padding-left: 5px;">
				<div class="panel panel-primary">
					<div class="panel-heading">
						<h3 class="panel-title">Balance Edit</h3>
                            ...
                            <td><%#Eval("Balance") %></td>
                             ...
                             <td><%#Eval("T_Date") %></td>
                                ...
                                <div class="btn btn-success glyphicon glyphicon-ok">
                                    ...
                                    <asp:LinkButton ID="LinkButton1" CommandArgument='<%# Eval("sr") %>' OnClick="EditLinkBtn_Click" runat="server" BackColor="Transparent" BorderWidth="0">Edit</asp:LinkButton>
                                </div>
