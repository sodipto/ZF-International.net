<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin MasterPage.master" AutoEventWireup="true" CodeFile="BalanceEdit.aspx.cs" Inherits="Admin_BalanceEdit" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <h2 style="text-align:center;">Passenger Edit Balance</h2>
    </br>
    ...
    <div class="form-group">
      <label for="email">
        ...
        <div style="padding-left:130px;">
          <asp:Button ID="paymentButton"  validationgroup="w" class="btn btn-danger" runat="server" Text="Add Payment" OnClick="paymentButton_Click" onclientclick="Alert_insert()" />
              ...
              <div class="row">
               ...
               <div class="panel panel-danger ">
                        ...
                        <div class="panel-body">Passport NO:  <asp:Label ID="Passport_label" runat="server" Text=""></asp:Label></div>
                         <div class="panel-body">Name:   <asp:Label ID="Name" runat="server" Text=""></asp:Label></div>
                        <div class="panel-footer">Total Balance:     <asp:Label ID="Balance_label" runat="server" Text="0"></asp:Label>     Taka</div>
                </div>
                  </div>
              </div>
