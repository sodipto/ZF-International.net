...
public partial class Admin_BalanceDetails : System.Web.UI.Page
{
    ...
    public void Show()
    {
        ...
        cmd.CommandText = "SELECT * FROM payment INNER join passenger ON payment.passportNo=passenger.Passport_No WHERE passenger.Passport_No='" + Session["passport_no"] + "' ";
