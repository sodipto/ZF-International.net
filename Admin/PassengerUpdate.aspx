<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PassengerUpdate.aspx.cs" Inherits="Admin_PassengerUpdate" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
     <title>ALL Passenger Update Here</title>
     <style type="text/css">
            	.row{
		    margin-top:40px;
		    padding: 0 10px;
...
<body>
    ...
    <div  class ="pull-left form-inline">
         ...
         <div class="btn btn-success glyphicon glyphicon-refresh">
             <asp:Button ID="Export_Button"  runat ="server" Text="Back Home" BackColor="Transparent" BorderWidth="0"   OnClick="Home_Button_Click1" />
                 ...
                 <HeaderTemplate>
                  ...
                  <ItemTemplate>
						...
						<tr>
                            ...
                            <td><%#Eval("Total_Balance") %> </br> <asp:LinkButton ID="LinkButton3" CommandArgument='<%# Eval("Passport_No") %>' onClick="BalanceDetails_Click" runat="server">Details</asp:LinkButton> </td>
							...
							<td style="text-align:center;">
                                ...
                                <div class="btn btn-success glyphicon glyphicon-ok">
                                   <%--  <asp:Button ID="Button1"  CommandArgument='<%# Eval("username") %>' OnClick="ENameLinkBtn_Click" runat="server" Text="Verify" BackColor="Transparent" BorderWidth="0" />--%>
                                    <asp:LinkButton ID="LinkButton1" CommandArgument='<%# Eval("Passport_No") %>' OnClick="EditLinkBtn_Click" runat="server" BackColor="Transparent" BorderWidth="0">Edit</asp:LinkButton>
                                </div>
