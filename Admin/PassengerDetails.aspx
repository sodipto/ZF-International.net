<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin MasterPage.master" AutoEventWireup="true" CodeFile="PassengerDetails.aspx.cs" Inherits="Admin_PassengerDetails" %>
                        ...
                        <tr>
                         ...
                         <tr>
                          ...
                          <tr>
                            ...
                            <td class="col-md-3"> <%#Eval("Total_Balance") %>   Taka  </br> <asp:LinkButton ID="LinkButton1" CommandArgument='<%# Eval("Passport_No") %>' onClick="BalanceDetails_Click" runat="server">Details</asp:LinkButton> </td>
