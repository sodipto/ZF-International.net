<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SentPermitEdit.aspx.cs" Inherits="Dataentry_SentPermitEdit" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Sent For Work Permit</title>
                           ...
                           <%-- <td>Edit</td>
                            <td>Delete</td>--%>
                                ...
                                <div class="btn btn-success glyphicon glyphicon-ok">
                                    ...
                                    <asp:LinkButton ID="LinkButton1" CommandArgument='<%# Eval("Passport_No") %>' OnClick="Export_Button_Click1" runat="server" BackColor="Transparent" BorderWidth="0">Edit</asp:LinkButton>
                                </div>
